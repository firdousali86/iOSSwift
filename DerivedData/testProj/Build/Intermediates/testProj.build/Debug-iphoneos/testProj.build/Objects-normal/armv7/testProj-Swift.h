...
SWIFT_CLASS("_TtC8testProj11AppDelegate")
...
SWIFT_CLASS("_TtC8testProj14BaseController")
@interface BaseController : UIViewController
- (void)viewDidLoad;
- (void)didReceiveMemoryWarning;
- (NSString * __nonnull)getViewName;
- (BOOL)loadView:(NSString * __nonnull)nib error:(NSError * __nullable * __null_unspecified)error;
- (nonnull instancetype)initWithNibName:(NSString * __nullable)nibNameOrNil bundle:(NSBundle * __nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * __nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC8testProj8BaseView")
...
SWIFT_CLASS("_TtC8testProj14MainController")
...
SWIFT_CLASS("_TtC8testProj8MainView")
